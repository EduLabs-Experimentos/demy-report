<div style="text-align: center;">
  <img src="./assets/images/upc-logo.png" alt="UPC Logo" style="width: 250px; height: auto;">
</div>
...
<h4 style="text-align: center"> NRC: 16789  </h4>

<h4 style="text-align: center"> Docente: Alex Humberto Sanchéz Ponce </h4>

<br>

<h3 style="text-align: center;"> Informe del Trabajo Final </h3>

<h4 style="text-align: center"> Startup: EduLabs </h4>
...
<div style="text-align:center; margin-top: 10px; font-size: 90%; line-height: 1.6;">
  ...
  <p>U202312318 — Dominguez Vargas, Rafael Alexander</p>
  <p>U202310210 — Esteban Roman, Henry Kalet</p>
  <p>U202121579 — Julca Cruz, Renso Anthony</p>
...
- [Capítulo II: Requirements Elicitation & Analysis](#capítulo-ii-requirements-elicitation-&-analysis)
    ...
    - [2.2. Entrevistas](#22-entrevistas)
         - [2.2.1. Diseño de Entrevistas](#211-diseño-de-entrevistas)
...
- [Capítulo IV: Product Design](#capítulo-iv-product-design)
  ...
  - [4.5. Mobile Applications Prototyping](#45-mobile-applications-prototyping)
    - [4.5.1. Android Mobile Application Prototyping](#451-android-mobile-application-prototyping)
    - [4.5.2. iOS Mobile Applications Prototyping](#452-ios-mobile-applications-prototyping)
  - [4.6. Web Applications UX/UI Design](#46-web-applications-uxui-design)
    - [4.6.1. Web Applications Wireframes](#461-web-applications-wireframes)
    - [4.6.2. Web Application Wireflow Diagrams](#462-web-application-wireflow-diagrams)
...
<td>Como administrador, quiero gestionar la información de la academia y sus miembros docentes para mantener datos actualizados y facilitar la administración.</td>
...
<td>Como administrador, quiero gestionar las inscripciones en la plataforma para asegurar que los usuarios estén correctamente registrados en los cursos.</td>
<td>— (Épica, no aplica)</td>
<td>Alta</td>
<td>—</td>
</tr>
...
<td>Como profesor, quiero registrar la asistencia en cada clase para llevar un control preciso y facilitar la gestión académica.</td>
<td>— (Épica, no aplica)</td>
<td>Alta</td>
<td>—</td>
</tr>
...
<td>Como administrador, quiero gestionar la emisión y seguimiento de las boletas de pago para asegurar que los usuarios cumplan con sus obligaciones financieras.</td>
<td>— (Épica, no aplica)</td>
<td>Media</td>
<td>—</td>
</tr>
...
<td>Como usuario, quiero gestionar la cuenta y autenticación para acceder de manera segura a la plataforma y proteger la información personal.</td>
<td>— (Épica, no aplica)</td>
<td>Alta</td>
<td>—</td>
</tr>
...
<td>Como visitante, quiero explorar el portal público para obtener información sobre la plataforma y los servicios antes de registrarme.</td>
<td>— (Épica, no aplica)</td>
<td>Baja</td>
<td>—</td>
</tr>
...
<td>Como developer, quiero implementar servicios técnicos y APIs REST para facilitar la integración con otros sistemas y asegurar la escalabilidad de la plataforma.</td>
<td>— (Épica, no aplica)</td>
<td>Alta</td>
<td>—</td>
</tr>
...
<td>Como equipo de desarrollo, quiero realizar investigación y prototipado para explorar nuevas tecnologías y enfoques que puedan mejorar la arquitectura de la solución propuesta.</td>
<td>— (Épica, no aplica)</td>
<td>Media</td>
<td>—</td>
</tr>
...
| **Ocupación**           | Coordinadora administrativa de academia de idiomas con 2 sedes (~220 alumnos) |
| **Fecha de entrevista** | 14/06/2026 |
| **Timing**              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **Video**               | [Ver en Microsoft Stream]()                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Captura**             | ![Captura](./assets/validation-interviews/screenshot-validation-administrator-1.jpeg)                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| Atributo                | Detalle                                                                                                |
|-------------------------|--------------------------------------------------------------------------------------------------------|
| **Nombre**              | Freddy Quispe Mamani |
| **Edad**                | 35 |
| **Sexo**                | Masculino |
| **Distrito**            | Comas (Lima) |
| **Ocupación**           | Profesor de Matemáticas en academia preuniversitaria |
| **Fecha de entrevista** | 14/06/2026 |
| **Timing**              |  |
| **Video**               | [Ver en Microsoft Stream]() |
| **Captura**             | ![Captura](./assets/validation-interviews/screenshot-validation-teacher-1.jpeg) |
| **Resumen**             | Freddy, profesor de una academia preuniversitaria en Lima que usa el celular como su principal herramienta de trabajo, evaluó la aplicación móvil para docentes de Demy con una percepción muy positiva. Desde la pantalla principal ubicó sus cursos y las sesiones del día sin dificultad, y registró la asistencia de forma rápida e intuitiva, destacando que marcar presente/ausente por alumno es el paso más claro y que ningún ícono o sección le resultó confuso. No experimentó demoras ni acciones que tomaran más tiempo del esperado, y el guardado inmediato de los datos junto con el inicio de sesión seguro le transmitieron confianza. Considera la herramienta muy útil para organizar sus clases y, sobre todo, para automatizar el control de asistencia, tarea que hoy realiza en papel y luego traslada a Excel; valora la inmediatez de hacerlo desde el celular en el momento y sin pérdida de información. Como mejoras a futuro sugirió un resumen de asistencia por alumno y notificaciones ante cambios de horario, aunque considera que lo esencial (horario y asistencia) ya está muy bien resuelto. Manifestó alta disposición a adoptar la app como herramienta principal y a recomendarla a otros profesores de su academia (9/10). |
